...
exports.registerUser = async ({ username, email, password, mnemonic }) => {
    ...
    const newUser = new User({ username, email: email, password: hashedPassword, mnemonic: encryptedMnemonic });
    await newUser.save();
